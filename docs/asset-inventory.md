...
| `public/assets/hero-carmen.png`                 | AI-generated original created for this project from ballet editorial palette direction | Estudio de Danza Carmen project / generated asset | Approved for this website fallback; no private rights evidence stored in repo                      | Home hero fallback and Sanity upload candidate  | `approved`             | Use as the production-safe fallback. Upload to Sanity with licence status `approved` and usage notes that it is AI-generated original imagery for this project. |
...
One public-path media asset is present as the production-safe fallback hero: `public/assets/hero-carmen.png`. It is an AI-generated original created for this project and may be uploaded to Sanity with licence status `approved`; final Carmen photography can still replace it later.
